...
const configurations: { [env: string]: Configuration } = {
  ...
  development: {
    ...
    externalTokens: {
      ...
      'DANTE-USDC-LP': ['0xd1ad205c09c0813c7A1A2A91F7FCde6240b55Cd4', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  DanteUSDCGrailRewardPool: {
    identifier: 'DanteUSDCGrailRewardPool',
    name: 'Earn Grail by Dante-Usdc Lp',
    poolId: 5,
    sectionInUI: 2,
    contract: 'GrailRewardPool',
    depositTokenName: 'DANTE-USDC-LP',
    depositTokenNameSpan: 'Dante-Usdc Lp',
    earnTokenName: 'GRAIL',
    finished: false,
    sort: 6,
    closedForStaking: false,
